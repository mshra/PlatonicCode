...
const ShimmerButton = React.forwardRef<HTMLDivElement, ShimmerButtonProps>(
  (
    {
      shimmerColor = "#ffffff",
      shimmerSize = "0.05em",
    ...
    return (
      <div
        ...
        tabIndex={0} // To make it focusable and clickable with keyboard
        onClick={onClick} // Ensuring onClick works
        style={
          {
            "--spread": "90deg",
